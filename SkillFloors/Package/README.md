# SkillFloors
SkillFloors is a Valheim Mod which creates a minimum skill level for each skill (the skill's "floor") which levels up more slowly than the skill. When you lose skill levels due to death, skill levels won't drop below their skill floors.
